...
- No long theory blocks. Explain concepts in one or two lines while the
  camera shows the thing, then move on.

## Hooks that fit the channel

The hook shows the finished build working, then makes one promise:

- "This robot sorts my resistors faster than I can - and the whole thing
  cost less than a pizza."
- "I gave my 3D printer a camera and now it messages me before a print
  fails."
...
- Under 60 characters, front-load the payoff.
- Patterns that fit the channel: "I built X that does Y", "X but it's Y",
  "The $Z DIY alternative to X".
- Never promise what the video does not show.
...
- Framing the channel as Python-only or automation-only.
